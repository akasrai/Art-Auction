    ...
    <div class="col-md-2 col-sm-12 ">
      <div class="col-md-12 product">
        <div class="product-image">
          <img src="<?php echo url('storage/' . $product->images[0]->image_url) ?>" alt="product image">
        </div>
        ...
        <div class="col-md-12 bid-product-button">
          <a class="btn btn-info" href="<?php echo url('auction/' . $product->slug) ?>">@lang('messages.bid')</a>
