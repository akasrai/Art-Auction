         ...
         <div class="col-md-12 product">
            ...
            <div class="product-title">
               ...
               <h3>Price: $
                  ...
                  <script>
                     let originalPrice = parseInt("{{$product->options->price}}");
                     let discountPercentage = parseInt("{{$product->options->discount}}");
                     let priceAfterDiscount = originalPrice - ((discountPercentage / 100) * originalPrice);
                     document.getElementById("{{$product->id}}").innerHTML = priceAfterDiscount;
                  </script>
               </h3>
