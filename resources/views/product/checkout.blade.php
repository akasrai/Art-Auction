    ...
    <div class="col-md-8 no-padding">
          ...
          <div class="col-md-12 no-padding">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <input id="state" type="text" class="form-control" name="state" value="{{$user->state}}" autofocus
                  autocomplete="off" required />
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12 no-padding">
            <div class="col-md-6">
              <div class="form-group row">
                ...
                <input id="country" type="text" class="form-control" name="country" value="{{$user->country}}" autofocus
                  autocomplete="off" required />
              </div>
            </div>
            <div class="col-md-6">
      ...
      <div id="review-page" class="col-md-12 dashboard-content hide">
        ...
        <div class="review-page">
          ...
          <div id="cash" class="col-md-3 no-padding hide" style="margin-top:20px;">
            <a href="/place-order" class="btn btn-primary auction-default-btn" id="place-order">Confirm
              Order</a>
          </div>

          <form method="POST" id="paypal" class="hide" action="{{ route('payment.payWithPaypal') }}">
            {{ csrf_field() }}

            <div class="col-md-3 no-padding" style="margin-top:20px;">
              <button class="btn btn-primary auction-default-btn" id="place-order">Confirm
                Order</button>
            </div>
          </form>
        </div>
